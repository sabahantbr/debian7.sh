...
curl http://script.gumballpeace.com/user-login.sh > user-login.sh
curl http://script.gumballpeace.com/user-expire.sh > user-expire.sh
curl http://script.gumballpeace.com/user-limit.sh > user-limit.sh
...
# info
clear
echo "gumballpeace.com" | tee log-install.txt
...
echo "Timezone : Malaysia"  | tee -a log-install.txt
